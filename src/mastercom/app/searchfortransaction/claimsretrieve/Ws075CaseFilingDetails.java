...
public class Ws075CaseFilingDetails  implements java.io.Serializable {
    ...
    private mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingDetails caseFilingDetails;

    private mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingRespHistory[] caseFilingRespHistory;
    ...
    public Ws075CaseFilingDetails(
           ...
           mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingDetails caseFilingDetails,
           mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingRespHistory[] caseFilingRespHistory) {
     ...
     */
    public mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingDetails getCaseFilingDetails() {
        return caseFilingDetails;
    }
     ...
     */
    public void setCaseFilingDetails(mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingDetails caseFilingDetails) {
        this.caseFilingDetails = caseFilingDetails;
    }
     ...
     */
    public mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingRespHistory[] getCaseFilingRespHistory() {
        return caseFilingRespHistory;
    }
     ...
     */
    public void setCaseFilingRespHistory(mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingRespHistory[] caseFilingRespHistory) {
        this.caseFilingRespHistory = caseFilingRespHistory;
    }

    public mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingRespHistory getCaseFilingRespHistory(int i) {
        return this.caseFilingRespHistory[i];
    }

    public void setCaseFilingRespHistory(int i, mastercom.app.searchfortransaction.claimsretrieve.DetCaseFilingRespHistory _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://app.mastercom/searchfortransaction/claimsretrieve/", "ws075-caseFilingDetails"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://app.mastercom/searchfortransaction/claimsretrieve/", "det-caseFilingDetails"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://app.mastercom/searchfortransaction/claimsretrieve/", "det-caseFilingRespHistory"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
