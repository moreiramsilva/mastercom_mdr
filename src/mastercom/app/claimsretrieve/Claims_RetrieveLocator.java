...
public class Claims_RetrieveLocator extends org.apache.axis.client.Service implements mastercom.app.claimsretrieve.Claims_Retrieve {
    ...
    private java.lang.String Claims_RetrieveSOAP_address = "http://10.206.116.188:8080/mastercom/services/Claims_RetrieveSOAP";
    ...
    public mastercom.app.claimsretrieve.Ws074_Claims_Retrieve getClaims_RetrieveSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public mastercom.app.claimsretrieve.Ws074_Claims_Retrieve getClaims_RetrieveSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mastercom.app.claimsretrieve.Ws074_Claims_RetrieveSOAPStub _stub = new mastercom.app.claimsretrieve.Ws074_Claims_RetrieveSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mastercom.app.claimsretrieve.Ws074_Claims_Retrieve.class.isAssignableFrom(serviceEndpointInterface)) {
                mastercom.app.claimsretrieve.Ws074_Claims_RetrieveSOAPStub _stub = new mastercom.app.claimsretrieve.Ws074_Claims_RetrieveSOAPStub(new java.net.URL(Claims_RetrieveSOAP_address), this);
                _stub.setPortName(getClaims_RetrieveSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://app.mastercom/claimsretrieve/", "Claims_Retrieve");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://app.mastercom/claimsretrieve/", "Claims_RetrieveSOAP"));
        }
